...
+ (void)showLoadFailedImageToastToView:(UIView *)view {
    ...
    //144 150
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 90, 93)];
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMinY(imageView.frame)- 50, view.frame.size.width, 50)];
    titleLabel.backgroundColor = [UIColor clearColor];
...
- (void)reloadFrame {
    ...
    if (!_hasContentView) {
        ...
        CGFloat messageHeight = [_messageLabel.text boundingRectWithSize:CGSizeMake(_alertWidth - viewPadding * 2, FLT_MAX)
                                                              ...
                                                              attributes:@{NSFontAttributeName:_messageLabel.font ? _messageLabel.font : [UIFont systemFontOfSize:14]}
